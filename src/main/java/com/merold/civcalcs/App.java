...
public class App {
	...
	Tile[][] grid = new Tile[][] { 
		{ tileX0Y0, tileX1Y0, 	tileX2Y0, 	tileX3Y0, 		null, 		null, 		null },
	...
	public static void main(String[] args) {
		...
		TargetTradeCity tenoch = new TargetTradeCity("Tenochtitlan", 6, 0.56, 1);
		...
		TargetTradeCity turfan = new TargetTradeCity("Turfan", 6, 0.31, 1);
		TargetTradeCity oldSarai = new TargetTradeCity("Old Sarai", 4, 0.43, 1);
		TargetTradeCity valetta = new TargetTradeCity("Valetta", 6, 0.62, 0);
		...
		TargetTradeCity constantinople = new TargetTradeCity("Constantinople", 6, 0.87, 1);
		...
		TargetTradeCity delhi = new TargetTradeCity("Delhi", 5, 1.2, 2);
		...
		capital.printOutput();
		capital.getTradeRoutes().stream().sorted((t1, t2) -> t2.getGoldYield().compareTo(t1.getGoldYield())).forEach(t -> System.out.println(t.getSourceCity().getName() + " -> " + t.getTargetCity().getName() + ": " + MathUtil.round(t.getGoldYield(),1) + (t.isAvailable() ? "" : "(*)") ));
	...
	private static void printAvailableBuildings(Game game, City capital, Player player) {
		...
		for (Buildable building : available) {
			System.out.println(building.getName() + " can be built in " + building.turnsToBuild(capital) + " turns.");
