...
import static com.merold.civcalcs.buildings.BuildingEnum.AIRPORT;
import static com.merold.civcalcs.buildings.BuildingEnum.ALHAMBRA;
import static com.merold.civcalcs.buildings.BuildingEnum.ANGKOR_WAT;
import static com.merold.civcalcs.buildings.BuildingEnum.ARMORY;
import static com.merold.civcalcs.buildings.BuildingEnum.ARTISTS_GUILD;
import static com.merold.civcalcs.buildings.BuildingEnum.BANK;
import static com.merold.civcalcs.buildings.BuildingEnum.BARRACKS;
import static com.merold.civcalcs.buildings.BuildingEnum.BRANDENBURG_GATE;
import static com.merold.civcalcs.buildings.BuildingEnum.CATHEDRAL;
import static com.merold.civcalcs.buildings.BuildingEnum.CHICHEN_ITZA;
import static com.merold.civcalcs.buildings.BuildingEnum.COLOSSUS;
import static com.merold.civcalcs.buildings.BuildingEnum.EAST_INDIA_COMPANY;
import static com.merold.civcalcs.buildings.BuildingEnum.EIFEL_TOWER;
import static com.merold.civcalcs.buildings.BuildingEnum.FORBIDDEN_PALACE;
import static com.merold.civcalcs.buildings.BuildingEnum.GLOBE_THEATER;
import static com.merold.civcalcs.buildings.BuildingEnum.GRANARY;
import static com.merold.civcalcs.buildings.BuildingEnum.GRAND_TEMPLE;
import static com.merold.civcalcs.buildings.BuildingEnum.GREAT_LIBRARY;
import static com.merold.civcalcs.buildings.BuildingEnum.GREAT_LIGHTHOUSE;
import static com.merold.civcalcs.buildings.BuildingEnum.GREAT_MOSQUE_OF_DJENNE;
import static com.merold.civcalcs.buildings.BuildingEnum.GREAT_WALL;
import static com.merold.civcalcs.buildings.BuildingEnum.HANGING_GARDENS;
import static com.merold.civcalcs.buildings.BuildingEnum.HARBOR;
import static com.merold.civcalcs.buildings.BuildingEnum.HERMITAGE;
import static com.merold.civcalcs.buildings.BuildingEnum.HEROIC_EPIC;
import static com.merold.civcalcs.buildings.BuildingEnum.HOSPITAL;
import static com.merold.civcalcs.buildings.BuildingEnum.HOTEL;
import static com.merold.civcalcs.buildings.BuildingEnum.HYDRO_PLANT;
import static com.merold.civcalcs.buildings.BuildingEnum.IRON_WORKS;
import static com.merold.civcalcs.buildings.BuildingEnum.LOUVRE;
import static com.merold.civcalcs.buildings.BuildingEnum.MACHU_PICH;
import static com.merold.civcalcs.buildings.BuildingEnum.MARKET;
import static com.merold.civcalcs.buildings.BuildingEnum.MAUSOLEUM_OF_HALICARNASSUS;
import static com.merold.civcalcs.buildings.BuildingEnum.MEDICAL_LAB;
import static com.merold.civcalcs.buildings.BuildingEnum.MONUMENT;
import static com.merold.civcalcs.buildings.BuildingEnum.MUSICIANS_GUILD;
import static com.merold.civcalcs.buildings.BuildingEnum.NATIONAL_COLLEGE;
import static com.merold.civcalcs.buildings.BuildingEnum.NATIONAL_EPIC;
import static com.merold.civcalcs.buildings.BuildingEnum.NATIONAL_INTELLIGENCE_AGENCY;
import static com.merold.civcalcs.buildings.BuildingEnum.NOTRE_DAME;
import static com.merold.civcalcs.buildings.BuildingEnum.OPERA_HOUSE;
import static com.merold.civcalcs.buildings.BuildingEnum.ORACLE;
import static com.merold.civcalcs.buildings.BuildingEnum.OXFORD_UNIVERSITY;
import static com.merold.civcalcs.buildings.BuildingEnum.PAGODA;
import static com.merold.civcalcs.buildings.BuildingEnum.PALACE;
import static com.merold.civcalcs.buildings.BuildingEnum.PARTHENON;
import static com.merold.civcalcs.buildings.BuildingEnum.PENTAGON;
import static com.merold.civcalcs.buildings.BuildingEnum.PYRAMIDS;
import static com.merold.civcalcs.buildings.BuildingEnum.RECYCLING_CENTER;
import static com.merold.civcalcs.buildings.BuildingEnum.RED_FORT;
import static com.merold.civcalcs.buildings.BuildingEnum.SEAPORT;
import static com.merold.civcalcs.buildings.BuildingEnum.SHRINE;
import static com.merold.civcalcs.buildings.BuildingEnum.SISTINE_CHAPEL;
import static com.merold.civcalcs.buildings.BuildingEnum.STABLE;
import static com.merold.civcalcs.buildings.BuildingEnum.STADIUM;
import static com.merold.civcalcs.buildings.BuildingEnum.STATUE_OF_ZEUS;
import static com.merold.civcalcs.buildings.BuildingEnum.STOCK_EXCHANGE;
import static com.merold.civcalcs.buildings.BuildingEnum.STONEHENGE;
import static com.merold.civcalcs.buildings.BuildingEnum.STONE_WORKS;
import static com.merold.civcalcs.buildings.BuildingEnum.SYDNEY_OPERA_HOUSE;
import static com.merold.civcalcs.buildings.BuildingEnum.TEMPLE;
import static com.merold.civcalcs.buildings.BuildingEnum.TEMPLE_OF_ARTEMIS;
import static com.merold.civcalcs.buildings.BuildingEnum.TERRA_COTTA_ARMY;
import static com.merold.civcalcs.buildings.BuildingEnum.UNIVERSITY;
import static com.merold.civcalcs.buildings.BuildingEnum.WALLS;
import static com.merold.civcalcs.buildings.BuildingEnum.WATER_MILL;
import static com.merold.civcalcs.buildings.BuildingEnum.WORKSHOP;
import static com.merold.civcalcs.buildings.BuildingEnum.WRITERS_GUILD;
import static com.merold.civcalcs.science.Tech.ACOUSTICS;
import static com.merold.civcalcs.science.Tech.ANIMAL_HUSBANDRY;
...
import static com.merold.civcalcs.science.Tech.ATOMIC_THEORY;
import static com.merold.civcalcs.science.Tech.BALLISTICS;
...
import static com.merold.civcalcs.science.Tech.ELECTRONICS;
import static com.merold.civcalcs.science.Tech.ENGINEERING;
import static com.merold.civcalcs.science.Tech.FERTILIZER;
...
import static com.merold.civcalcs.science.Tech.SAILING;
import static com.merold.civcalcs.science.Tech.STEAM_POWER;
...
import static com.merold.civcalcs.socialpolicies.SocialPolicy.ARISTOCRACY;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.FREEDOM;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.LANDED_ELITE;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.LEGALISM;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.MONARCHY;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.NAVAL_TRADITION;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.OLIGARCHY;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.PIETY;
import static com.merold.civcalcs.socialpolicies.SocialPolicy.TRADITION;
import static com.merold.civcalcs.tiles.BaseTerrain.COAST;
import static com.merold.civcalcs.tiles.BaseTerrain.DESERT;
import static com.merold.civcalcs.tiles.BaseTerrain.GRASSLAND;
import static com.merold.civcalcs.tiles.BaseTerrain.PLAINS;
import static com.merold.civcalcs.tiles.BaseTerrain.TUNDRA;
import static com.merold.civcalcs.tiles.TerrainFeature.BORDERS_COAST;
import static com.merold.civcalcs.tiles.TerrainFeature.FOREST;
import static com.merold.civcalcs.tiles.TerrainFeature.HILL;
import static com.merold.civcalcs.tiles.TerrainFeature.MOUNTAIN;
import static com.merold.civcalcs.tiles.TerrainFeature.RIVER;
...
public class App {
	...
	public static void main(String[] args) {
		...
		TargetTradeCity turfan = new TargetTradeCity("Turfan", 6, 0.5, 1, mongolia);
		TargetTradeCity oldSarai = new TargetTradeCity("Old Sarai", 4, 0.56, 1, mongolia);
		...
		TargetTradeCity constantinople = new TargetTradeCity("Constantinople", 6, 1.66, 2, byzantium);
		...
		TargetTradeCity delhi = new TargetTradeCity("Delhi", 5, 3.32, 3, india);
		...
		TargetTradeCity nicaea = new TargetTradeCity("Nicaea", 5, .18, 0, byzantium);
		TargetTradeCity adrianople = new TargetTradeCity("Adrianople", 5, .75, 1, byzantium);
		...
		capital.completeBuildable();
		TargetTradeCity newSarai = new TargetTradeCity("New Sarai", 5, 0.1, 0, mongolia, true);
		capital.addAvailableTradeRoute(newSarai, RouteType.SEA);
		capital.addAvailableTradeRoute(newSarai, RouteType.LAND);
		capital.startBuilding(UnitEnum.CARGO_SHIP);
		player.adopt(SocialPolicy.NATIONAL_HEALTHCARE);
		
		game.setCurrentTurn(369);
		CargoShip cargoShip8 = new CargoShip(player);
		cargoShip8.setHomeCity(capital);
		cargoShip8.establishTradeRoute();
		
		game.setCurrentTurn(370);
		player.discover(Tech.ROCKETRY);
		
		game.setCurrentTurn(371);
		capital.grow();
		grid[4][2].work(capital);
		
		game.setCurrentTurn(375);
		player.adopt(SocialPolicy.ECONOMIC_UNION);
		
		game.setCurrentTurn(380);
		capital.grow();
		grid[2][3].work(capital);
		capital.addGreatWorkOfArt();
		
		game.setCurrentTurn(381);
		player.discover(Tech.COMPUTERS);
		capital.startBuilding(BuildingEnum.GREAT_FIREWALL);
		...
		capital.printOutput();
		 ...
		 .forEach(t -> System.out.println("(" + t.routeType + ")" + t.getSourceCity().getName() + " -> "
